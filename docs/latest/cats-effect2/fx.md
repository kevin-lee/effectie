...
If you feel it's too cumbersome to repeat `Fx[F].effectOf()`, use `effectie.syntax.all._`.


## Syntax

If you're sick of repeating `Fx[F].effectOf()` and looking for more convenient ways?, use `effectie.syntax` instead.
