...
object EitherTSupportSpec extends Properties {
  ...
  object EitherTFEitherOpsSpec {
    ...
    import effectie.cats.EitherTSupport.eitherT
  ...
  object EitherTFAOpsSpec {
    ...
    import cats.effect.*
    import cats.syntax.either.*
    import effectie.cats.EitherTSupport.{rightT, leftT}
  ...
  object EitherTAOpsSpec {
    ...
    import cats.effect.*
    import cats.syntax.either.*
    import effectie.cats.EitherTSupport.{rightTF, leftTF}
