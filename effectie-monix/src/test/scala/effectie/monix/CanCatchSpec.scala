...
object CanCatchSpec extends Properties {
  ...
  override def tests: List[Test] = List(
    /* Task */
    example("test CanCatch[Task].catchNonFatal should catch NonFatal", TaskSpec.testCanCatch_Task_catchNonFatalShouldCatchNonFatal),
    example("test CanCatch[Task].catchNonFatal should not catch Fatal", TaskSpec.testCanCatch_Task_catchNonFatalShouldNotCatchFatal),
    example("test CanCatch[Task].catchNonFatal should return the successful result", TaskSpec.testCanCatch_Task_catchNonFatalShouldReturnSuccessfulResult),

    example("test CanCatch[Task].catchNonFatalEither should catch NonFatal", TaskSpec.testCanCatch_Task_catchNonFatalEitherShouldCatchNonFatal),
    example("test CanCatch[Task].catchNonFatalEither should not catch Fatal", TaskSpec.testCanCatch_Task_catchNonFatalEitherShouldNotCatchFatal),
    example("test CanCatch[Task].catchNonFatalEither should return the successful result", TaskSpec.testCanCatch_Task_catchNonFatalEitherShouldReturnSuccessfulResult),
    example("test CanCatch[Task].catchNonFatalEither should return the failed result", TaskSpec.testCanCatch_Task_catchNonFatalEitherShouldReturnFailedResult),

    example("test CanCatch[Task].catchNonFatalEitherT should catch NonFatal", TaskSpec.testCanCatch_Task_catchNonFatalEitherTShouldCatchNonFatal),
    example("test CanCatch[Task].catchNonFatalEitherT should not catch Fatal", TaskSpec.testCanCatch_Task_catchNonFatalEitherTShouldNotCatchFatal),
    example("test CanCatch[Task].catchNonFatalEitherT should return the successful result", TaskSpec.testCanCatch_Task_catchNonFatalEitherTShouldReturnSuccessfulResult),
    example("test CanCatch[Task].catchNonFatalEitherT should return the failed result", TaskSpec.testCanCatch_Task_catchNonFatalEitherTShouldReturnFailedResult),
  ...
  object FutureSpec {
    ...
    def testCanCatch_Future_catchNonFatalEitherTShouldCatchNonFatal: Result = {
      ...
      val expected = SomeError.someThrowable(expectedExpcetion).asLeft[Int]
      val actual = futureToValue(CanCatch[Future].catchNonFatalEitherT(fa)(SomeError.someThrowable).value)
