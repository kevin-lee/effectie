...
import effectie.scalaz.FxCtor
import effectie.{ConcurrentSupport, SomeControlThrowable}
import effectie.scalaz.Effectful._
import effectie.scalaz.syntax.error._
...
//    ),
  ...
  object IoSpec {
    ...
    def testCanCatch_IO_catchNonFatalThrowableShouldCatchNonFatal: Result = {
      ...
      val actual            = fa.catchNonFatalThrowable.unsafePerformIO()
    ...
    def testCanCatch_IO_catchNonFatalThrowableShouldReturnSuccessfulResult: Result = {
      ...
      val fa       = run[IO, Int](1)
      val expected = 1.right[Throwable]
      val actual   = fa.catchNonFatalThrowable.unsafePerformIO()
    ...
    def testCanCatch_IO_catchNonFatalShouldCatchNonFatal: Result = {
      ...
      val actual            = fa.catchNonFatal(SomeError.someThrowable).unsafePerformIO()
    ...
    def testCanCatch_IO_catchNonFatalEitherShouldCatchNonFatal: Result = {
      ...
      val expected          = SomeError.someThrowable(expectedExpcetion).left[Int]
      val actual            = fa.catchNonFatalEither(SomeError.someThrowable).unsafePerformIO()
    ...
    def testCanCatch_IO_catchNonFatalEitherTShouldCatchNonFatal: Result = {
      ...
      val expected          = SomeError.someThrowable(expectedExpcetion).left[Int]
      val actual            = fa.catchNonFatalEitherT(SomeError.someThrowable).run.unsafePerformIO()
  ...
  object FutureSpec {
    ...
    def testCanCatch_Future_catchNonFatalEitherTShouldCatchNonFatal: Result = {
      ...
      val expected          = SomeError.someThrowable(expectedExpcetion).left[Int]
      val actual            = ConcurrentSupport.futureToValueAndTerminate(
        fa.catchNonFatalEitherT(SomeError.someThrowable).run,
        waitFor
      )
  ...
  object IdSpec {
    ...
    def testCanCatch_Id_catchNonFatalEitherTShouldCatchNonFatal: Result = {
      ...
      val expected          = SomeError.someThrowable(expectedExpcetion).left[Int]
      val actual            = fa.catchNonFatalEitherT(SomeError.someThrowable).run
...
//    ),
  ...
  object IoSpec {
    ...
    def testCanHandleError_IO_handleNonFatalWithShouldNotHandleFatalWith: Result = {
      ...
      try {
        val actual = fa.handleNonFatalWith(_ => IO(123)).unsafePerformIO()
        Result.failure.log(s"The expected fatal exception was not thrown. actual: ${actual.toString}")
      } catch {
        case ex: ControlThrowable =>
          ex ==== fatalExpcetion
    ...
    def testCanHandleError_IO_handleNonFatalWithShouldReturnSuccessfulResult: Result = {
      ...
      val fa       = run[IO, Int](1)
      val expected = 1
      val actual   = fa.handleNonFatalWith(_ => IO(999)).unsafePerformIO()
    ...
    def testCanHandleError_IO_handleNonFatalWithEitherShouldHandleNonFatalWith: Result = {
      ...
      val actualFailedResult   =
        fa.handleNonFatalWith(_ => IO(expectedFailedResult)).unsafePerformIO()

      val expectedSuccessResult = 1.right[SomeError]
      val actualSuccessResult   = fa.handleNonFatalWith(_ => IO(1.right[SomeError])).unsafePerformIO()
    ...
    def testCanHandleError_IO_handleNonFatalWithEitherShouldNotHandleFatalWith: Result = {
      ...
      try {
        val actual = fa.handleNonFatalWith(_ => IO(123.right[SomeError])).unsafePerformIO()
        Result.failure.log(s"The expected fatal exception was not thrown. actual: ${actual.toString}")
      } catch {
        case ex: ControlThrowable =>
          ex ==== fatalExpcetion
    ...
    def testCanHandleError_IO_handleNonFatalWithEitherShouldReturnSuccessfulResult: Result = {
      ...
      val fa       = run[IO, SomeError \/ Int](1.right[SomeError])
      val expected = 1.right[SomeError]
      val actual   = fa.handleNonFatalWith(_ => IO(999.right[SomeError])).unsafePerformIO()
    ...
    def testCanHandleError_IO_handleEitherNonFatalWithShouldHandleNonFatalWith: Result = {
      ...
      val actualFailedResult    = fa
        .handleEitherNonFatalWith(err => IO(SomeError.someThrowable(err).left[Int]))
        .unsafePerformIO()
      val expectedSuccessResult = 123.right[SomeError]
      val actualSuccessResult   =
        fa.handleEitherNonFatalWith(_ => IO(123.right[SomeError])).unsafePerformIO()
    ...
    def testCanHandleError_IO_handleEitherNonFatalWithShouldNotHandleFatalWith: Result = {
      ...
      try {
        val actual =
          fa.handleEitherNonFatalWith(err => IO(SomeError.someThrowable(err).left[Int]))
            .unsafePerformIO()
        Result.failure.log(s"The expected fatal exception was not thrown. actual: ${actual.toString}")
      } catch {
        case ex: ControlThrowable =>
    ...
    def testCanHandleError_IO_handleEitherNonFatalWithShouldReturnSuccessfulResult: Result = {
      ...
      val fa       = run[IO, SomeError \/ Int](1.right[SomeError])
      val expected = 1.right[SomeError]
      val actual   = fa.handleEitherNonFatalWith(_ => IO(123.right[SomeError])).unsafePerformIO()
    ...
    def testCanHandleError_IO_handleEitherTNonFatalWithShouldHandleNonFatalWith: Result = {
      ...
      val expectedFailedResult  = SomeError.someThrowable(expectedExpcetion).left[Int]
      val actualFailedResult    = fa
        .handleEitherTNonFatalWith(err => IO(SomeError.someThrowable(err).left[Int]))
        .run
        .unsafePerformIO()
      val expectedSuccessResult = 123.right[SomeError]
      val actualSuccessResult   =
        fa.handleEitherTNonFatalWith(_ => IO(123.right[SomeError])).run.unsafePerformIO()
    ...
    def testCanHandleError_IO_handleEitherTNonFatalWithShouldNotHandleFatalWith: Result = {
      ...
      try {
        val actual =
          fa.handleEitherTNonFatalWith(err => IO(SomeError.someThrowable(err).left[Int]))
            .run
            .unsafePerformIO()
        Result.failure.log(s"The expected fatal exception was not thrown. actual: ${actual.toString}")
      } catch {
    ...
    def testCanHandleError_IO_handleEitherTNonFatalWithShouldReturnSuccessfulResult: Result = {
      ...
      val fa       = EitherT(run[IO, SomeError \/ Int](1.right[SomeError]))
      val expected = 1.right[SomeError]
      val actual   = fa.handleEitherTNonFatalWith(_ => IO(123.right[SomeError])).run.unsafePerformIO()
    ...
    def testCanHandleError_IO_handleNonFatalShouldNotHandleFatal: Result = {
      ...
      try {
        val actual = fa.handleNonFatal(_ => 123).unsafePerformIO()
        Result.failure.log(s"The expected fatal exception was not thrown. actual: ${actual.toString}")
      } catch {
        case ex: ControlThrowable =>
          ex ==== fatalExpcetion
    ...
    def testCanHandleError_IO_handleNonFatalShouldReturnSuccessfulResult: Result = {
      ...
      val fa       = run[IO, Int](1)
      val expected = 1
      val actual   = fa.handleNonFatal(_ => 999).unsafePerformIO()
    ...
    def testCanHandleError_IO_handleNonFatalEitherShouldHandleNonFatal: Result = {
      ...
      val fa                   = run[IO, SomeError \/ Int](throwThrowable[SomeError \/ Int](expectedExpcetion))
      val expectedFailedResult = SomeError.message("Recovered Error").left[Int]
      val actualFailedResult   = fa.handleNonFatal(_ => expectedFailedResult).unsafePerformIO()

      val expectedSuccessResult = 1.right[SomeError]
      val actualSuccessResult   = fa.handleNonFatal(_ => 1.right[SomeError]).unsafePerformIO()
    ...
    def testCanHandleError_IO_handleNonFatalEitherShouldNotHandleFatal: Result = {
      ...
      try {
        val actual = fa.handleNonFatal(_ => 123.right[SomeError]).unsafePerformIO()
        Result.failure.log(s"The expected fatal exception was not thrown. actual: ${actual.toString}")
      } catch {
        case ex: ControlThrowable =>
          ex ==== fatalExpcetion
    ...
    def testCanHandleError_IO_handleNonFatalEitherShouldReturnSuccessfulResult: Result = {
      ...
      val fa       = run[IO, SomeError \/ Int](1.right[SomeError])
      val expected = 1.right[SomeError]
      val actual   = fa.handleNonFatal(_ => 999.right[SomeError]).unsafePerformIO()
    ...
    def testCanHandleError_IO_handleEitherNonFatalShouldHandleNonFatal: Result = {
      ...
      val expectedFailedResult  = SomeError.someThrowable(expectedExpcetion).left[Int]
      val actualFailedResult    = fa
        .handleEitherNonFatal(err => SomeError.someThrowable(err).left[Int])
        .unsafePerformIO()
      val expectedSuccessResult = 123.right[SomeError]
      val actualSuccessResult   =
        fa.handleEitherNonFatal(_ => 123.right[SomeError]).unsafePerformIO()
    ...
    def testCanHandleError_IO_handleEitherNonFatalShouldNotHandleFatal: Result = {
      ...
      try {
        val actual =
          fa.handleEitherNonFatal(err => SomeError.someThrowable(err).left[Int])
            .unsafePerformIO()
        Result.failure.log(s"The expected fatal exception was not thrown. actual: ${actual.toString}")
      } catch {
        case ex: ControlThrowable =>
    ...
    def testCanHandleError_IO_handleEitherNonFatalShouldReturnSuccessfulResult: Result = {
      ...
      val fa       = run[IO, SomeError \/ Int](1.right[SomeError])
      val expected = 1.right[SomeError]
      val actual   = fa.handleEitherNonFatal(_ => 123.right[SomeError]).unsafePerformIO()
    ...
    def testCanHandleError_IO_handleEitherTNonFatalShouldHandleNonFatal: Result = {
      ...
      val expectedFailedResult  = SomeError.someThrowable(expectedExpcetion).left[Int]
      val actualFailedResult    = fa
        .handleEitherTNonFatal(err => SomeError.someThrowable(err).left[Int])
        .run
        .unsafePerformIO()
      val expectedSuccessResult = 123.right[SomeError]
      val actualSuccessResult   =
        fa.handleEitherTNonFatal(_ => 123.right[SomeError]).run.unsafePerformIO()
    ...
    def testCanHandleError_IO_handleEitherTNonFatalShouldNotHandleFatal: Result = {
      ...
      try {
        val actual =
          fa.handleEitherTNonFatal(err => SomeError.someThrowable(err).left[Int])
            .run
            .unsafePerformIO()
        Result.failure.log(s"The expected fatal exception was not thrown. actual: ${actual.toString}")
      } catch {
    ...
    def testCanHandleError_IO_handleEitherTNonFatalShouldReturnSuccessfulResult: Result = {
      ...
      val fa       = EitherT(run[IO, SomeError \/ Int](1.right[SomeError]))
      val expected = 1.right[SomeError]
      val actual   = fa.handleEitherTNonFatal(_ => 123.right[SomeError]).run.unsafePerformIO()
  ...
  object FutureSpec {
    ...
    def testCanHandleError_Future_handleNonFatalWithEitherShouldHandleNonFatalWith: Result = {
      ...
      val actualFailedResult   =
        ConcurrentSupport.futureToValue(
          fa.handleNonFatalWith(err => Future(SomeError.someThrowable(err).left[Int])),
          waitFor
        )
    ...
    def testCanHandleError_Future_handleNonFatalWithEitherShouldReturnFailedResult: Result = {
      ...
      val expected        = expectedFailure.left[Int]
      val actual          = ConcurrentSupport.futureToValueAndTerminate(
        fa.handleNonFatalWith(_ => Future(1.right[SomeError])),
        waitFor
      )
    ...
    def testCanHandleError_Future_handleEitherNonFatalWithShouldHandleNonFatalWith: Result = {
      ...
      val actualFailedResult   = ConcurrentSupport.futureToValue(
        fa.handleEitherNonFatalWith(err => Future(SomeError.someThrowable(err).left[Int])),
        waitFor
      )
    ...
    def testCanHandleError_Future_handleEitherTNonFatalWithShouldHandleNonFatalWith: Result = {
      ...
      val expectedFailedResult = SomeError.someThrowable(expectedExpcetion).left[Int]
      val actualFailedResult   = ConcurrentSupport.futureToValue(
        fa.handleEitherTNonFatalWith(err => Future(SomeError.someThrowable(err).left[Int])).run,
        waitFor
      )
      ...
      val actual   =
        ConcurrentSupport.futureToValueAndTerminate(
          fa2.handleEitherTNonFatalWith(err => Future(expected)).run,
          waitFor
        )
    ...
    def testCanHandleError_Future_handleEitherTNonFatalWithShouldReturnFailedResult: Result = {
      ...
      val actual          =
        ConcurrentSupport.futureToValueAndTerminate(
          fa.handleEitherTNonFatalWith(_ => Future(expected)).run,
          waitFor
        )
    ...
    def testCanHandleError_Future_handleNonFatalEitherShouldHandleNonFatal: Result = {
      ...
      val actualFailedResult   =
        ConcurrentSupport.futureToValue(
          fa.handleNonFatal(err => SomeError.someThrowable(err).left[Int]),
          waitFor
        )
    ...
    def testCanHandleError_Future_handleNonFatalEitherShouldReturnFailedResult: Result = {
      ...
      val expected        = expectedFailure.left[Int]
      val actual          = ConcurrentSupport.futureToValueAndTerminate(
        fa.handleNonFatal(_ => 1.right[SomeError]),
        waitFor
      )
    ...
    def testCanHandleError_Future_handleEitherTNonFatalShouldHandleNonFatal: Result = {
      ...
      val expectedFailedResult = SomeError.someThrowable(expectedExpcetion).left[Int]
      val actualFailedResult   = ConcurrentSupport.futureToValue(
        fa.handleEitherTNonFatal(err => SomeError.someThrowable(err).left[Int]).run,
        waitFor
      )
      ...
      val actual   =
        ConcurrentSupport.futureToValueAndTerminate(
          fa2.handleEitherTNonFatal(err => expected).run,
          waitFor
        )
    ...
    def testCanHandleError_Future_handleEitherTNonFatalShouldReturnFailedResult: Result = {
      ...
      val actual          =
        ConcurrentSupport.futureToValueAndTerminate(
          fa.handleEitherTNonFatal(_ => expected).run,
          waitFor
        )
  ...
  object IdSpec {
    ...
    def testCanHandleError_Id_handleNonFatalWithEitherShouldHandleNonFatalWith: Result = {
      ...
      val expectedFailedResult = SomeError.someThrowable(expectedExpcetion).left[Int]
      val actualFailedResult   =
        fa.handleNonFatalWith(err => SomeError.someThrowable(err).left[Int]: Id[SomeError \/ Int])

      lazy val fa2 = run[Id, SomeError \/ Int](throwThrowable[SomeError \/ Int](expectedExpcetion))
      val expected = 1.right[SomeError]
      val actual   = fa2.handleNonFatalWith(_ => expected: Id[SomeError \/ Int])
    ...
    def testCanHandleError_Id_handleNonFatalWithEitherShouldNotHandleFatalWith: Result = {
      ...
      try {
        val actual = fa.handleNonFatalWith(_ => 1.right[SomeError]: Id[SomeError \/ Int])
        Result.failure.log(s"The expected fatal exception was not thrown. actual: ${actual.toString}")
      } catch {
        case ex: ControlThrowable =>
          ex ==== fatalExpcetion
    ...
    def testCanHandleError_Id_handleNonFatalWithEitherShouldReturnSuccessfulResult: Result = {
      ...
      val fa       = run[Id, SomeError \/ Int](1.right[SomeError])
      val expected = 1.right[SomeError]
      val actual   = fa.handleNonFatalWith(err => SomeError.someThrowable(err).left[Int]: Id[SomeError \/ Int])
    ...
    def testCanHandleError_Id_handleEitherNonFatalWithShouldHandleNonFatalWith: Result = {
      ...
      val expectedFailedResult = SomeError.someThrowable(expectedExpcetion).left[Int]
      val actualFailedResult   =
        fa.handleEitherNonFatalWith(err => SomeError.someThrowable(err).left[Int]: Id[SomeError \/ Int])

      lazy val fa2 = run[Id, SomeError \/ Int](throwThrowable[SomeError \/ Int](expectedExpcetion))
      val expected = 1.right[SomeError]
      val actual   = fa2.handleEitherNonFatalWith(_ => expected: Id[SomeError \/ Int])
    ...
    def testCanHandleError_Id_handleEitherNonFatalWithShouldNotHandleFatalWith: Result = {
      ...
      try {
        val actual = fa.handleEitherNonFatalWith(_ => 1.right[SomeError]: Id[SomeError \/ Int])
        Result.failure.log(s"The expected fatal exception was not thrown. actual: ${actual.toString}")
      } catch {
        case ex: ControlThrowable =>
          ex ==== fatalExpcetion
    ...
    def testCanHandleError_Id_handleEitherNonFatalWithShouldReturnSuccessfulResult: Result = {
      ...
      val fa       = run[Id, SomeError \/ Int](1.right[SomeError])
      val expected = 1.right[SomeError]
      val actual   = fa.handleEitherNonFatalWith(err => SomeError.someThrowable(err).left[Int]: Id[SomeError \/ Int])
    ...
    def testCanHandleError_Id_handleEitherTNonFatalWithShouldHandleNonFatalWith: Result = {
      ...
      val expectedFailedResult = SomeError.someThrowable(expectedExpcetion).left[Int]
      val actualFailedResult   =
        fa.handleEitherTNonFatalWith(err => SomeError.someThrowable(err).left[Int]).run

      lazy val fa2 = EitherT(run[Id, SomeError \/ Int](throwThrowable[SomeError \/ Int](expectedExpcetion)))
      val expected = 1.right[SomeError]
      val actual   = fa2.handleEitherTNonFatalWith(_ => expected).run
    ...
    def testCanHandleError_Id_handleEitherTNonFatalWithShouldNotHandleFatalWith: Result = {
      ...
      try {
        val actual = fa.handleEitherTNonFatalWith(_ => 1.right[SomeError]).run
        Result.failure.log(s"The expected fatal exception was not thrown. actual: ${actual.toString}")
      } catch {
        case ex: ControlThrowable =>
          ex ==== fatalExpcetion
    ...
    def testCanHandleError_Id_handleEitherTNonFatalWithShouldReturnSuccessfulResult: Result = {
      ...
      val fa       = EitherT(run[Id, SomeError \/ Int](1.right[SomeError]))
      val expected = 1.right[SomeError]
      val actual   = fa.handleEitherTNonFatalWith(err => SomeError.someThrowable(err).left[Int]).run
    ...
    def testCanHandleError_Id_handleNonFatalEitherShouldHandleNonFatal: Result = {
      ...
      lazy val fa              = run[Id, SomeError \/ Int](throwThrowable[SomeError \/ Int](expectedExpcetion))
      val expectedFailedResult = SomeError.someThrowable(expectedExpcetion).left[Int]
      val actualFailedResult   = fa.handleNonFatal(err => SomeError.someThrowable(err).left[Int])
    ...
    def testCanHandleError_Id_handleNonFatalEitherShouldNotHandleFatal: Result = {
      ...
      try {
        val actual = fa.handleNonFatal(_ => 1.right[SomeError])
        Result.failure.log(s"The expected fatal exception was not thrown. actual: ${actual.toString}")
      } catch {
        case ex: ControlThrowable =>
          ex ==== fatalExpcetion
    ...
    def testCanHandleError_Id_handleNonFatalEitherShouldReturnSuccessfulResult: Result = {
      ...
      val fa       = run[Id, SomeError \/ Int](1.right[SomeError])
      val expected = 1.right[SomeError]
      val actual   = fa.handleNonFatal(err => SomeError.someThrowable(err).left[Int])
    ...
    def testCanHandleError_Id_handleEitherNonFatalShouldNotHandleFatal: Result = {
      ...
      try {
        val actual = fa.handleEitherNonFatal(_ => 1.right[SomeError])
        Result.failure.log(s"The expected fatal exception was not thrown. actual: ${actual.toString}")
      } catch {
        case ex: ControlThrowable =>
          ex ==== fatalExpcetion
    ...
    def testCanHandleError_Id_handleEitherNonFatalShouldReturnSuccessfulResult: Result = {
      ...
      val fa       = run[Id, SomeError \/ Int](1.right[SomeError])
      val expected = 1.right[SomeError]
      val actual   = fa.handleEitherNonFatal(err => SomeError.someThrowable(err).left[Int])
    ...
    def testCanHandleError_Id_handleEitherTNonFatalShouldHandleNonFatal: Result = {
      ...
      lazy val fa2 = EitherT(run[Id, SomeError \/ Int](throwThrowable[SomeError \/ Int](expectedExpcetion)))
      val expected = 1.right[SomeError]
      val actual   = fa2.handleEitherTNonFatal(_ => expected).run
    ...
    def testCanHandleError_Id_handleEitherTNonFatalShouldNotHandleFatal: Result = {
      ...
      try {
        val actual = fa.handleEitherTNonFatal(_ => 1.right[SomeError]).run
        Result.failure.log(s"The expected fatal exception was not thrown. actual: ${actual.toString}")
      } catch {
        case ex: ControlThrowable =>
          ex ==== fatalExpcetion
    ...
    def testCanHandleError_Id_handleEitherTNonFatalShouldReturnSuccessfulResult: Result = {
      ...
      val fa       = EitherT(run[Id, SomeError \/ Int](1.right[SomeError]))
      val expected = 1.right[SomeError]
      val actual   = fa.handleEitherTNonFatal(err => SomeError.someThrowable(err).left[Int]).run
...
//    ),
  ...
  object IoSpec {
    ...
    def testCanRecover_IO_recoverFromNonFatalWithShouldNotCatchFatal: Result = {
      ...
      val io = fa.recoverFromNonFatalWith { case NonFatal(`expectedExpcetion`) => IO(123) }
      try {
    ...
    def testCanRecover_IO_recoverFromNonFatalShouldReturnSuccessfulResult: Result = {
      ...
      val fa       = run[IO, Int](1)
      val expected = 1
      val actual   = fa.recoverFromNonFatal { case NonFatal(_) => 999 }.unsafePerformIO()
    ...
    def testCanRecover_IO_recoverFromNonFatalEitherShouldRecoverFromNonFatal: Result = {
      ...
      val expectedSuccessResult = 1.right[SomeError]
      val actualSuccessResult   = fa
        .recoverFromNonFatal { case NonFatal(`expectedExpcetion`) => 1.right[SomeError] }
        .unsafePerformIO()
    ...
    def testCanRecover_IO_recoverFromNonFatalEitherShouldNotCatchFatal: Result = {
      ...
      val io = fa.recoverFromNonFatal { case NonFatal(`expectedExpcetion`) => 123.right[SomeError] }
      try {
        val actual = io.unsafePerformIO()
        Result.failure.log(s"The expected fatal exception was not thrown. actual: ${actual.toString}")
      } catch {
    ...
    def testCanRecover_IO_recoverFromNonFatalEitherShouldReturnSuccessfulResult: Result = {
      ...
      val fa       = run[IO, SomeError \/ Int](1.right[SomeError])
      val expected = 1.right[SomeError]
      val actual   = fa.recoverFromNonFatal { case NonFatal(_) => 999.right[SomeError] }.unsafePerformIO()
    ...
    def testCanRecover_IO_recoverFromNonFatalEitherShouldReturnFailedResult: Result = {
      ...
      val fa              = run[IO, SomeError \/ Int](expectedFailure.left[Int])
      val expected        = expectedFailure.left[Int]
      val actual          = fa.recoverFromNonFatal { case NonFatal(_) => 123.right[SomeError] }.unsafePerformIO()
    ...
    def testCanRecover_IO_recoverEitherFromNonFatalShouldRecoverFromNonFatal: Result = {
      ...
      val expectedSuccessResult = 123.right[SomeError]
      val actualSuccessResult   =
        fa.recoverEitherFromNonFatal { case NonFatal(`expectedExpcetion`) => 123.right[SomeError] }
          .unsafePerformIO()
    ...
    def testCanRecover_IO_recoverEitherFromNonFatalShouldReturnSuccessfulResult: Result = {
      ...
      val expected = 1.right[SomeError]
      val actual   =
        fa.recoverEitherFromNonFatal { case NonFatal(_) => 123.right[SomeError] }.unsafePerformIO()
    ...
    def testCanRecover_IO_recoverEitherTFromNonFatalShouldRecoverFromNonFatal: Result = {
      ...
      val expectedSuccessResult = 123.right[SomeError]
      val actualSuccessResult   =
        fa.recoverEitherTFromNonFatal { case NonFatal(`expectedExpcetion`) => 123.right[SomeError] }
          .run
          .unsafePerformIO()
    ...
    def testCanRecover_IO_recoverEitherTFromNonFatalShouldReturnSuccessfulResult: Result = {
      ...
      val expected = 1.right[SomeError]
      val actual   =
        fa.recoverEitherTFromNonFatal { case NonFatal(_) => 123.right[SomeError] }.run.unsafePerformIO()
  ...
  object FutureSpec {
    ...
    def testCanRecover_Future_recoverFromNonFatalEitherShouldReturnFailedResult: Result = {
      ...
      val expected        = expectedFailure.left[Int]
      val actual          = ConcurrentSupport.futureToValueAndTerminate(
        fa.recoverFromNonFatal { case NonFatal(_) => 1.right[SomeError] },
        waitFor
      )
    ...
    def testCanRecover_Future_recoverEitherTFromNonFatalShouldRecoverFromNonFatal: Result = {
      ...
      val actual   =
        ConcurrentSupport.futureToValueAndTerminate(
          fa2.recoverEitherTFromNonFatal { case err => expected }.run,
          waitFor
        )
    ...
    def testCanRecover_Future_recoverEitherTFromNonFatalShouldReturnFailedResult: Result = {
      ...
      val actual          =
        ConcurrentSupport.futureToValueAndTerminate(
          fa.recoverEitherTFromNonFatal { case NonFatal(_) => expected }.run,
          waitFor
        )
  ...
  object IdSpec {
    ...
    def testCanRecover_Id_recoverFromNonFatalWithEitherShouldRecoverFromNonFatal: Result = {
      ...
      val actualFailedResult   = fa.recoverFromNonFatalWith {
        case err => SomeError.someThrowable(err).left[Int]: Id[SomeError \/ Int]
      }

      val expected = 1.right[SomeError]
      val actual   = fa.recoverFromNonFatalWith { case NonFatal(`expectedExpcetion`) => expected: Id[SomeError \/ Int] }
    ...
    def testCanRecover_Id_recoverFromNonFatalWithEitherShouldNotCatchFatal: Result = {
      ...
      try {
        val actual = fa.recoverFromNonFatalWith {
          case NonFatal(`expectedExpcetion`) => 1.right[SomeError]: Id[SomeError \/ Int]
        }
        Result.failure.log(s"The expected fatal exception was not thrown. actual: ${actual.toString}")
      } catch {
        case ex: ControlThrowable =>
    ...
    def testCanRecover_Id_recoverFromNonFatalWithEitherShouldReturnFailedResult: Result = {
      ...
      val fa              = run[Id, SomeError \/ Int](expectedFailure.left[Int])
      val expected        = expectedFailure.left[Int]
      val actual          = fa.recoverFromNonFatalWith { case NonFatal(_) => 1.right[SomeError]: Id[SomeError \/ Int] }
    ...
    def testCanRecover_Id_recoverEitherFromNonFatalWithShouldRecoverFromNonFatal: Result = {
      ...
      val expected = 1.right[SomeError]
      val actual   =
        fa.recoverEitherFromNonFatalWith { case NonFatal(`expectedExpcetion`) => expected: Id[SomeError \/ Int] }
    ...
    def testCanRecover_Id_recoverEitherFromNonFatalWithShouldReturnFailedResult: Result = {
      ...
      val expected        = expectedFailure.left[Int]
      val actual          =
        fa.recoverEitherFromNonFatalWith { case NonFatal(_) => 1.right[SomeError]: Id[SomeError \/ Int] }
    ...
    def testCanRecover_Id_recoverEitherTFromNonFatalWithShouldRecoverFromNonFatal: Result = {
      ...
      val expected = 1.right[SomeError]
      val actual   =
        fa.recoverEitherTFromNonFatalWith { case NonFatal(`expectedExpcetion`) => expected }.run
    ...
    def testCanRecover_Id_recoverEitherTFromNonFatalWithShouldNotCatchFatal: Result = {
      ...
      try {
        val actual = fa.recoverEitherTFromNonFatalWith { case NonFatal(`expectedExpcetion`) => 1.right[SomeError] }.run
        Result.failure.log(s"The expected fatal exception was not thrown. actual: ${actual.toString}")
      } catch {
        case ex: ControlThrowable =>
          ex ==== expectedExpcetion
    ...
    def testCanRecover_Id_recoverEitherTFromNonFatalWithShouldReturnFailedResult: Result = {
      ...
      val expected        = expectedFailure.left[Int]
      val actual          =
        fa.recoverEitherTFromNonFatalWith { case NonFatal(_) => 1.right[SomeError] }.run
    ...
    def testCanRecover_Id_recoverFromNonFatalEitherShouldNotCatchFatal: Result = {
      ...
      try {
        val actual = fa.recoverFromNonFatal { case NonFatal(`expectedExpcetion`) => 1.right[SomeError] }
        Result.failure.log(s"The expected fatal exception was not thrown. actual: ${actual.toString}")
      } catch {
        case ex: ControlThrowable =>
          ex ==== expectedExpcetion
    ...
    def testCanRecover_Id_recoverFromNonFatalEitherShouldReturnFailedResult: Result = {
      ...
      val fa              = run[Id, SomeError \/ Int](expectedFailure.left[Int])
      val expected        = expectedFailure.left[Int]
      val actual          = fa.recoverFromNonFatal { case NonFatal(_) => 1.right[SomeError] }
    ...
    def testCanRecover_Id_recoverEitherFromNonFatalShouldRecoverFromNonFatal: Result = {
      ...
      val expected = 1.right[SomeError]
      val actual   = fa.recoverEitherFromNonFatal { case NonFatal(`expectedExpcetion`) => expected }
    ...
    def testCanRecover_Id_recoverEitherFromNonFatalShouldNotCatchFatal: Result = {
      ...
      try {
        val actual =
          fa.recoverEitherFromNonFatal { case NonFatal(`expectedExpcetion`) => 1.right[SomeError] }
        Result.failure.log(s"The expected fatal exception was not thrown. actual: ${actual.toString}")
      } catch {
        case ex: ControlThrowable =>
          ex ==== expectedExpcetion
    ...
    def testCanRecover_Id_recoverEitherFromNonFatalShouldReturnFailedResult: Result = {
      ...
      val fa              = run[Id, SomeError \/ Int](expectedFailure.left[Int])
      val expected        = expectedFailure.left[Int]
      val actual          = fa.recoverEitherFromNonFatal { case NonFatal(_) => 1.right[SomeError] }
    ...
    def testCanRecover_Id_recoverEitherTFromNonFatalShouldRecoverFromNonFatal: Result = {
      ...
      val expected = 1.right[SomeError]
      val actual   = fa.recoverEitherTFromNonFatal { case NonFatal(`expectedExpcetion`) => expected }.run
    ...
    def testCanRecover_Id_recoverEitherTFromNonFatalShouldNotCatchFatal: Result = {
      ...
      try {
        val actual =
          fa.recoverEitherTFromNonFatal { case NonFatal(`expectedExpcetion`) => 1.right[SomeError] }.run
        Result.failure.log(s"The expected fatal exception was not thrown. actual: ${actual.toString}")
      } catch {
        case ex: ControlThrowable =>
          ex ==== expectedExpcetion
    ...
    def testCanRecover_Id_recoverEitherTFromNonFatalShouldReturnFailedResult: Result = {
      ...
      val fa              = EitherT(run[Id, SomeError \/ Int](expectedFailure.left[Int]))
      val expected        = expectedFailure.left[Int]
      val actual          = fa.recoverEitherTFromNonFatal { case NonFatal(_) => 1.right[SomeError] }.run
