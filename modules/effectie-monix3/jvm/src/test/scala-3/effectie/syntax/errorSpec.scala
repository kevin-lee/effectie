...
object CanHandleErrorSyntaxSpec {
  ...
  object IoSpec {
    ...
    def testCanHandleError_IO_handleNonFatalWithShouldNotHandleFatalWith: Result = {
      ...
      try {
        val actual = fa.handleNonFatalWith(_ => IO.pure(123)).runSyncUnsafe()
        Result.failure.log(s"The expected fatal exception was not thrown. actual: ${actual.toString}")
      } catch {
    ...
    def testCanHandleError_IO_handleNonFatalWithShouldReturnSuccessfulResult: Result = {
      ...
      val fa       = run[Task, Int](1)
      val expected = 1
      val actual   = fa.handleNonFatalWith(_ => IO.pure(999)).runSyncUnsafe()
      val actual2  = handleNonFatalWith(fa)(_ => IO.pure(999)).runSyncUnsafe()
    ...
    def testCanHandleError_IO_handleNonFatalWithEitherShouldHandleNonFatalWith: Result = {
      ...
      val actualFailedResult   =
        fa.handleNonFatalWith(_ => IO.pure(expectedFailedResult)).runSyncUnsafe()

      val expectedSuccessResult = 1.asRight[SomeError]
      val actualSuccessResult   =
        fa.handleNonFatalWith(_ => IO.pure(1.asRight[SomeError])).runSyncUnsafe()
    ...
    def testCanHandleError_IO_handleNonFatalWithEitherShouldNotHandleFatalWith: Result = {
      ...
      try {
        val actual = fa.handleNonFatalWith(_ => IO.pure(123.asRight[SomeError])).runSyncUnsafe()
        Result.failure.log(s"The expected fatal exception was not thrown. actual: ${actual.toString}")
      } catch {
        case ex: SomeControlThrowable =>
          ex.getMessage ==== fatalExpcetion.getMessage
    ...
    def testCanHandleError_IO_handleNonFatalWithEitherShouldReturnSuccessfulResult: Result = {
      ...
      val fa       = run[Task, Either[SomeError, Int]](1.asRight[SomeError])
      val expected = 1.asRight[SomeError]
      val actual   = fa.handleNonFatalWith(_ => IO(999.asRight[SomeError])).runSyncUnsafe()
      val actual2  = handleNonFatalWith(fa)(_ => IO(999.asRight[SomeError])).runSyncUnsafe()
    ...
    def testCanHandleError_IO_handleNonFatalWithEitherShouldReturnFailedResult: Result = {
      ...
      val expected        = expectedFailure.asLeft[Int]
      val actual          = fa.handleNonFatalWith(_ => IO.pure(123.asRight[SomeError])).runSyncUnsafe()
      val actual2         = handleNonFatalWith(fa)(_ => IO.pure(123.asRight[SomeError])).runSyncUnsafe()
    ...
    def testCanHandleError_IO_handleEitherNonFatalWithShouldHandleNonFatalWith: Result = {
      ...
      val actualSuccessResult   =
        fa.handleEitherNonFatalWith(_ => IO.pure(123.asRight[SomeError])).runSyncUnsafe()
    ...
    def testCanHandleError_IO_handleEitherNonFatalWithShouldReturnSuccessfulResult: Result = {
      ...
      val actual   =
        fa.handleEitherNonFatalWith(_ => IO.pure(123.asRight[SomeError])).runSyncUnsafe()
      val actual2  =
        handleEitherNonFatalWith(fa)(_ => IO.pure(123.asRight[SomeError])).runSyncUnsafe()
    ...
    def testCanHandleError_IO_handleEitherTNonFatalWithShouldHandleNonFatalWith: Result = {
      ...
      val expectedSuccessResult = 123.asRight[SomeError]
      val actualSuccessResult   =
        fa.handleEitherTNonFatalWith(_ => IO.pure(123.asRight[SomeError])).value.runSyncUnsafe()
    ...
    def testCanHandleError_IO_handleEitherTNonFatalWithShouldReturnSuccessfulResult: Result = {
      ...
      val actual   =
        fa.handleEitherTNonFatalWith(_ => IO.pure(123.asRight[SomeError])).value.runSyncUnsafe()
      val actual2  =
        handleEitherTNonFatalWith(fa)(_ => IO.pure(123.asRight[SomeError])).value.runSyncUnsafe()
