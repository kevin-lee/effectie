...
object fxSpec extends Properties {
  override def tests: List[Test] = List(
    ...
    property("test fx.effectOf[Task]", IoSpec.testEffectOf),
    property("test fx.fromEffect[Task](IO[A])", IoSpec.testFromEffect),
    property("test fx.fromEffect[Task](IO.pure[A])", IoSpec.testFromEffectWithPure),
    property("test fx.pureOf[Task]", IoSpec.testPureOf),
    property("test fx.pureOrError[Task](success case)", IoSpec.testPureOrErrorSuccessCase),
    example("test fx.pureOrError[Task](error case)", IoSpec.testPureOrErrorErrorCase),
    example("test fx.unitOf[Task]", IoSpec.testUnitOf),
    example("test fx.errorOf[Task]", IoSpec.testErrorOf),
    property("test fx.pureOfOption[Task]", IoSpec.testPureOfOption),
    property("test fx.pureOfSome[Task]", IoSpec.testPureOfSome),
    example("test fx.pureOfNone[Task]", IoSpec.testPureOfNone),
    property("test fx.pureOfRight[Task]", IoSpec.testPureOfRight),
    property("test fx.pureOfLeft[Task]", IoSpec.testPureOfLeft),
    //
