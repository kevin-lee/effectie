...
object CanHandleErrorSpec extends Properties {
  ...
  private val ioSpecs = List(
    example(
      ...
      IoSpec.testCanHandleError_Task_handleNonFatalWithShouldHandleNonFatalWith,
    ),
    example(
      "test CanHandleError[Task].handleNonFatalWith should not handle Fatal",
      IoSpec.testCanHandleError_Task_handleNonFatalWithShouldNotHandleFatalWith,
    ),
    example(
      "test CanHandleError[Task].handleNonFatalWith should return the successful result",
      IoSpec.testCanHandleError_Task_handleNonFatalWithShouldReturnSuccessfulResult,
    ),
    example(
      "test CanHandleError[Task].handleNonFatalWithEither should handle NonFatal",
      IoSpec.testCanHandleError_Task_handleNonFatalWithEitherShouldHandleNonFatalWith,
    ),
    example(
      "test CanHandleError[Task].handleNonFatalWithEither should not handle Fatal",
      IoSpec.testCanHandleError_Task_handleNonFatalWithEitherShouldNotHandleFatalWith,
    ),
    example(
      "test CanHandleError[Task].handleNonFatalWithEither should return the successful result",
      IoSpec.testCanHandleError_Task_handleNonFatalWithEitherShouldReturnSuccessfulResult,
    ),
    example(
      "test CanHandleError[Task].handleNonFatalWithEither should return the failed result",
      IoSpec.testCanHandleError_Task_handleNonFatalWithEitherShouldReturnFailedResult,
    ),
    example(
      "test CanHandleError[Task].handleEitherNonFatalWith should handle NonFatal",
      IoSpec.testCanHandleError_Task_handleEitherNonFatalWithShouldHandleNonFatalWith,
    ),
    example(
      "test CanHandleError[Task].handleEitherNonFatalWith should not handle Fatal",
      IoSpec.testCanHandleError_Task_handleEitherNonFatalWithShouldNotHandleFatalWith,
    ),
    example(
      "test CanHandleError[Task].handleEitherNonFatalWith should return the successful result",
      IoSpec.testCanHandleError_Task_handleEitherNonFatalWithShouldReturnSuccessfulResult,
    ),
    example(
      "test CanHandleError[Task].handleEitherNonFatalWith should return the failed result",
      IoSpec.testCanHandleError_Task_handleEitherNonFatalWithShouldReturnFailedResult,
    ),
    example(
      "test CanHandleError[Task].handleEitherTNonFatalWith should handle NonFatal",
      IoSpec.testCanHandleError_Task_handleEitherTNonFatalWithShouldHandleNonFatalWith,
    ),
    example(
      "test CanHandleError[Task].handleEitherTNonFatalWith should not handle Fatal",
      IoSpec.testCanHandleError_Task_handleEitherTNonFatalWithShouldNotHandleFatalWith,
    ),
    example(
      "test CanHandleError[Task].handleEitherTNonFatalWith should return the successful result",
      IoSpec.testCanHandleError_Task_handleEitherTNonFatalWithShouldReturnSuccessfulResult,
    ),
    example(
      "test CanHandleError[Task].handleEitherTNonFatalWith should return the failed result",
      IoSpec.testCanHandleError_Task_handleEitherTNonFatalWithShouldReturnFailedResult,
    ),
    example(
      "test CanHandleError[Task].handleNonFatal should handle NonFatal",
      IoSpec.testCanHandleError_Task_handleNonFatalShouldHandleNonFatal,
    ),
    example(
      "test CanHandleError[Task].handleNonFatal should not handle Fatal",
      IoSpec.testCanHandleError_Task_handleNonFatalShouldNotHandleFatal,
    ),
    example(
      "test CanHandleError[Task].handleNonFatal should return the successful result",
      IoSpec.testCanHandleError_Task_handleNonFatalShouldReturnSuccessfulResult,
    ),
    example(
      "test CanHandleError[Task].handleNonFatalEither should handle NonFatal",
      IoSpec.testCanHandleError_Task_handleNonFatalEitherShouldHandleNonFatal,
    ),
    example(
      "test CanHandleError[Task].handleNonFatalEither should not handle Fatal",
      IoSpec.testCanHandleError_Task_handleNonFatalEitherShouldNotHandleFatal,
    ),
    example(
      "test CanHandleError[Task].handleNonFatalEither should return the successful result",
      IoSpec.testCanHandleError_Task_handleNonFatalEitherShouldReturnSuccessfulResult,
    ),
    example(
      "test CanHandleError[Task].handleNonFatalEither should return the failed result",
      IoSpec.testCanHandleError_Task_handleNonFatalEitherShouldReturnFailedResult,
    ),
    example(
      "test CanHandleError[Task].handleEitherNonFatal should handle NonFatal",
      IoSpec.testCanHandleError_Task_handleEitherNonFatalShouldHandleNonFatal,
    ),
    example(
      "test CanHandleError[Task].handleEitherNonFatal should not handle Fatal",
      IoSpec.testCanHandleError_Task_handleEitherNonFatalShouldNotHandleFatal,
    ),
    example(
      "test CanHandleError[Task].handleEitherNonFatal should return the successful result",
      IoSpec.testCanHandleError_Task_handleEitherNonFatalShouldReturnSuccessfulResult,
    ),
    example(
      "test CanHandleError[Task].handleEitherNonFatal should return the failed result",
      IoSpec.testCanHandleError_Task_handleEitherNonFatalShouldReturnFailedResult,
    ),
    example(
      "test CanHandleError[Task].handleEitherTNonFatal should handle NonFatal",
      IoSpec.testCanHandleError_Task_handleEitherTNonFatalShouldHandleNonFatal,
    ),
    example(
      "test CanHandleError[Task].handleEitherTNonFatal should not handle Fatal",
      IoSpec.testCanHandleError_Task_handleEitherTNonFatalShouldNotHandleFatal,
    ),
    example(
      "test CanHandleError[Task].handleEitherTNonFatal should return the successful result",
      IoSpec.testCanHandleError_Task_handleEitherTNonFatalShouldReturnSuccessfulResult,
    ),
    example(
      "test CanHandleError[Task].handleEitherTNonFatal should return the failed result",
      IoSpec.testCanHandleError_Task_handleEitherTNonFatalShouldReturnFailedResult,
    ),
  )
