...
/** @author Kevin Lee
  * @since 2021-05-16
  */
class fxSpec extends munit.FunSuite with FutureTools with CommonFxSpec with fxSpec.fxTaskSpec with fxSpec.fxFutureSpec
trait CommonFxSpec {
...
object fxSpec {
  trait fxTaskSpec {
    ...
    test("test fx.{effectOf, pureOf, unitOf} for Task") {
    ...
    test("test fx.fromEffect[Task](Task[A])") {
      val before = RandomGens.genRandomIntWithMinMax(Int.MinValue, Int.MaxValue)
      val after  = RandomGens.genRandomIntWithMinMax(Int.MinValue, Int.MaxValue) + before
    ...
    test("test fx.fromEffect[Task](Task.pure[A])") {
      val before = RandomGens.genRandomIntWithMinMax(Int.MinValue, Int.MaxValue)
      val after  = RandomGens.genRandomIntWithMinMax(Int.MinValue, Int.MaxValue) + before
    ...
    test("test fx.pureOrError[Task](success case)") {
      val before = RandomGens.genRandomIntWithMinMax(Int.MinValue, Int.MaxValue)
      val after  = RandomGens.genRandomIntWithMinMax(Int.MinValue, Int.MaxValue) + before
    ...
    test("test fx.pureOrError[Task](error case)") {
    ...
    test("test fx.pureOfOption[Task] Some case") {
    ...
    test("test fx.pureOfOption[Task] None case") {
      val s = none[String]
