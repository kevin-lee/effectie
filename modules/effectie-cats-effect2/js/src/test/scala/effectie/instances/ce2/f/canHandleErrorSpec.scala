...
/** @author Kevin Lee
  * @since 2020-08-17
  */
object canHandleErrorSpec extends munit.FunSuite with FutureTools {
  ...
  test("test CanHandleError[IO].handleNonFatalWith should not handle Fatal") {
    ...
    CanHandleError[IO].handleNonFatalWith(fa)(_ => IO.pure(123)).unsafeToFuture()
      .transform {
        case Success(actual) =>
          Success(Assertions.fail(s"The expected fatal exception was not thrown. actual: ${actual.toString}"))

        case Failure(ex: ControlThrowable) =>
          Success(Assertions.assertEquals(ex, fatalExpcetion))
  ...
  test("test CanHandleError[IO].handleNonFatalWith should return the successful result") {
    ...
    val fa       = run[IO, Int](1)
    val expected = 1
    CanHandleError[IO].handleNonFatalWith(fa)(_ => IO.pure(999)).unsafeToFuture()
      .map { actual =>
        Assertions.assertEquals(actual, expected)
      }
      .unsafeToFuture()
  ...
  test("test CanHandleError[IO].handleNonFatalWithEither should handle NonFatal") {
    ...
    val actualFailedResult = 
      CanHandleError[IO].handleNonFatalWith(fa)(_ => IO.pure(expectedFailedResult)).unsafeToFuture()
    ...
    val actualSuccessResult   =
      CanHandleError[IO].handleNonFatalWith(fa)(_ => IO.pure(1.asRight[SomeError])).unsafeToFuture()
  ...
  test("test CanHandleError[IO].handleNonFatalWithEither should not handle Fatal") {
    ...
    CanHandleError[IO].handleNonFatalWith(fa)(_ => IO.pure(123.asRight[SomeError])).unsafeToFuture()
      .transform {
        case Success(actual) =>
          Success(Assertions.fail(s"The expected fatal exception was not thrown. actual: ${actual.toString}"))
  ...
  test("test CanHandleError[IO].handleNonFatalWithEither should return the successful result") {
    ...
    CanHandleError[IO].handleNonFatalWith(fa)(_ => IO(999.asRight[SomeError]))
      .map { actual =>
        Assertions.assertEquals(actual, expected)
      }
    .unsafeToFuture()
  ...
  test("test CanHandleError[IO].handleNonFatalWithEither should return the failed result") {
    ...
    CanHandleError[IO].handleNonFatalWith(fa)(_ => IO.pure(123.asRight[SomeError]))
      .map { actual =>
        Assertions.assertEquals(actual, expected)
      }
    .unsafeToFuture()
  ...
  test("test CanHandleError[IO].handleEitherNonFatalWith should handle NonFatal") {
    ...
    val actualSuccessResult   =
      CanHandleError[IO].handleEitherNonFatalWith(fa)(_ => IO.pure(123.asRight[SomeError])).unsafeToFuture()
  ...
  test("test CanHandleError[IO].handleNonFatal should not handle Fatal") {
    ...
    CanHandleError[IO].handleNonFatal(fa)(_ => 123)
      .unsafeToFuture()
      .transform {
        case Success(actual) =>
          Success(Assertions.fail(s"The expected fatal exception was not thrown. actual: ${actual.toString}"))
  ...
  test("test CanHandleError[IO].handleNonFatal should return the successful result") {
    ...
    val fa       = run[IO, Int](1)
    val expected = 1
    CanHandleError[IO].handleNonFatal(fa)(_ => 999)
      .map { actual =>
        Assertions.assertEquals(actual, expected)
      }
      .unsafeToFuture()
  ...
  test("test CanHandleError[IO].handleNonFatalEither should not handle Fatal") {
    ...
    CanHandleError[IO].handleNonFatal(fa)(_ => 123.asRight[SomeError])
      .unsafeToFuture()
      .transform {
        case Success(actual) =>
          Success(Assertions.fail(s"The expected fatal exception was not thrown. actual: ${actual.toString}"))
